...
# double join
# first joining authors and series on their id
# then joining subgenres and series on their id
...
# another double join
# first joining authors and series on their id
# then joining characters and series on their id
...
# join characters with character_books
# and also join books with character_books
# order data by two columns
# first by count of books each character appears in
# then alphabetical order by character name for each count
